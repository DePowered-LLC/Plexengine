...
<IfModule mod_rewrite.c>
    ...
    function step_0() { ?>
        <div id="welcome">
            ...
            Добро пожаловать в мастер установки Plexngine. Данный мастер поможет вам установить скрипт всего за пару минут. Однако, не смотря на это, мы настоятельно рекомендуем Вам ознакомиться с документацией по работе с движком.
            <br />
            <br />
        ...
        <table>
            <tbody>
                ...
                <tr>
                    ...
                    <?php if(!$pe_version): ?>
                        <td>Разрешите доступ к <code><?php echo $base_url; ?></code> в Ваше файерволе</td>
                        <td><div class="icon err"></div></td>
                        <?php $is_error = true; ?>
                    <?php else: ?>
                        <td>OK</td>
...
afk_time=10
    ...
    ?>
        ...
        <br />
        Поздравляем, Plexengine был успешно установлен на Ваш сервер.
        <br />
