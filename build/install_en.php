...
<IfModule mod_rewrite.c>
    ...
    function step_0() { ?>
        <div id="welcome">
            ...
            Welcome to the Plexngine Installation Wizard. This wizard will help you install the script in two minutes. However, despite this, we strongly recommend you familiarize with documentation about working with engine.
            <br />
            <br />
            ...
            <br />
            <br />
            Wishing you a pleasant work,<br />
            Plexengine Group
        </div>
    <?php }
...
nick_regexp='_a-zA-Z0-9А-Яа-яіІїЇєЄ;'
    ...
    ?>
        ...
        <br />
        Congratulations, Plexengine has been successfully installed on your server.
        <br />
